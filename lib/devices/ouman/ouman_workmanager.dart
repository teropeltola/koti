...
class OumanWorkmanager {
  ...
  factory OumanWorkmanager.fromJson(Map<String, dynamic> json) =>
      OumanWorkmanager(
  ...
  WorkmanagerTrendEventBox event = WorkmanagerTrendEventBox();
...
Future<bool> oumanWorkmanagerFunction(String taskName, Map<String, dynamic> inputData) async {
  OumanWorkmanager oumanWorkmanager = OumanWorkmanager.fromJson(inputData);
  await oumanWorkmanager.init();
  return await oumanWorkmanager.getData();
}
